...
public class MenuPanel extends JPanel implements MouseMotionListener {
	...
	public MenuPanel(MenuFrame frame) {
		...
		cursorCustom = Toolkit.getDefaultToolkit().createCustomCursor(ImageProvider.getCursor(), new Point(0, 0),
				"cursorCustom");
		...
		esc.addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				int option = JOptionPane.showConfirmDialog(MenuPanel.this, "Do you really want to exit?", "Exit",
